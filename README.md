...
- **引擎**：Unity 2022.3 LTS
- **AR 套件**：Unity AR Foundation 5.x、ARCore XR Plugin（Android）、ARKit XR Plugin（iOS）
- **UI**：TextMeshPro
- **語言**：C#
...
📧 [Raycheng940629@gmail.com](mailto:Raycheng940629@gmail.com)
